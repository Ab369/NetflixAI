...
const Signup=()=>{
    ...
    return(
        <div className=''>
            ...
            <div className='Signup z-10 text-white absolute flex flex-col bg-black px-16 py-10 md:gap-20 gap-14 md:bg-opacity-80 bg-opacity-100 lg:left-1/3 md:left-1/4 top-1/4  max-md:w-full'>
